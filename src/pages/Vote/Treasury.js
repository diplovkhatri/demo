  ...
  return (
    <div className="container font-rock bg-white w-full md:w-full mt-4">
      ...
      <div className="w-full flex rounded-xl p-2">
        {/*  */}
        <div className="border-4 md:overflow-hidden shadow-xl p-2 m-2 rounded-xl border-black w-1/4">
        ...
        {/*  */}
        <div className="border-4 shadow p-2 m-2 rounded-xl w-1/3 border-black">
          <span className="text-stone-600 font-semibold text-2xl opacity-80 ">
            $ USD
          </span>
        ...
        {/*  */}
        <div className="border-4  shadow p-2 m-2 rounded-xl w-1/2 border-black">
